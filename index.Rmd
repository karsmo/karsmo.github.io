...
```{r, echo = FALSE, message=FALSE, fig.align='center', fig.cap='The rule network construction from the rule', out.width='0.95'}
...
```{r, echo = FALSE, warning=FALSE, fig.cap='The sample rule network for the autistic and non-autistic young males classifier from VisuNet (constructed for min Support=17 and min Accuracy=88%)'}
